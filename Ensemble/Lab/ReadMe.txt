...
Please find below the Lab for Ensemble Techniques course. Kindly make your submission before the deadline.

Data Set -

pima-indians-diabetes.dataView in a new window

ColumnNames Information - https://www.kaggle.com/uciml/pima-indians-diabetes-database/data (Links to an external site.)Links to an external site.

Problem Set 

Load the PIMA Indian Diabetes file into Python DataFrame. You may first download it to a local folder and then load it into Python dataframe. Let us assume the data frame is named  “pima_df.
